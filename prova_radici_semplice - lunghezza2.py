...
def Colorazione(y,x,l_radice):
    ...
    while (row_area<y+2):
        col_area = x-1
        while (col_area<x+2):
            if (img[row_area,col_area,G] >= 220 and (row_area!=inizio_radice_y or col_area!=inizio_radice_x)): # quando si incontra un punto bianco, ovvero un punto medio      ==[255]
                if img[row_area,col_area,B] >= 250:
                    flag=True
                    l_radice+=1
                    img[row_area,col_area,B]=150
                    img[row_area,col_area,G]=200
                ...
                elif(img[row_area,col_area,B] <100):
                    l_radice+=1
                    flag=False
                    green_found=True
                    fine_radice_y = row_area
                    fine_radice_x = col_area
                    risultato[row_area,col_area]=[255,255,10] 
